...
function ceta_funds() {
	...
	if(!empty($user_id)) {
		...
		$vWatchlist = explode(',', $results[0]->watchlist);
	}	
...
function func_watchlist_button() {
	...
	$html = '<button class="butt-watchlist ' . $buttonColor . ' fusion-button button-flat fusion-button-default-shape fusion-button-default-size button-default button-11 fusion-button-default-span fusion-button-default-type" data-status="' . $fundStatus . '" data-id="' . $_GET['id'] . '" data-type="nlfundlist" data-userid="' . $user_id . '" >' . $buttStr . '</button>';
